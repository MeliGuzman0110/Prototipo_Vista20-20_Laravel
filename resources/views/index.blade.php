            ...
            <nav class="landing-page-nav">
                ...
                <div class="container d-flex align-items-center justify-content-between" style="margin-bottom: 10px;">
                    ...
                    <a class="navbar-logo pull-left scrollTo" href="#home">
                        ...
                        <img alt="optica logo"src="logos/opt-icon.png" width="130" height="65"/>
                    ...
                    <div class="container" id="citas">
                        ...
                        <div class="row mb-5">
                            <div class="col-12 offset-0 col-lg-8 offset-lg-2 text-center">
                                ...
                                href="img/landing-page/cita.png">AGENDAR CITA</a>
                    </div>
                    <br>
                    <br>
                    <br>
                            ...
                            <div class="col-12 text-center footer-content">
                                ...
                                <div>
                                    <a href="https://www.facebook.com/OpticasChavarriaCostaRica">
                                        <img class="footer-logo-fb"  alt="footer logo fb" width="64" height="64" src="logos/fb-icon.png" style="border:0px;margin:30px;" />
                                    </a>
                                    <a href="https://www.instagram.com/opticaschavarria/?hl=es">
                                        <img class="footer-logo-ig"  alt="footer logo ig" width="64" height="64" src="logos/ig-icon.png" style="border:0px;margin:30px;"/>
                                    </a>
                                    <a href="https://www.youtube.com/channel/UC0oQsl4lOv_1_8UBr6V89vw">
                                        <img class="footer-logo-yt"  alt="footer logo yt" width="64" height="64" src="logos/yt-icon.png" style="border:0px;margin:30px;"/>
                                    </a>
